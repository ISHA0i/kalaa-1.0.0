...
// import { fetchCartItems, formatPrice, validateQuantity } from './CartController';
...
//   const fetchCartItemsWrapper = useCallback(async () => {
//     try {
//       setLoading(true);
//       await fetchCartItems(setCartItems, null, navigate);
//       setError(null);
//     } catch (error) {
//       setError('Failed to fetch cart items. Using fallback data.');
//     } finally {
//       setLoading(false);
//     }
//   }, [navigate]);
...
import React, { useState, useEffect, useCallback, useMemo } from 'react';
import { useNavigate } from 'react-router-dom';
import { fetchCartItems, formatPrice } from './CartController';
import '../../../styles/Cart.css';
